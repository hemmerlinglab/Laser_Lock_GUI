...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.tabs.addTab(self.tab_main, "390")
...
### Tab 2
        ...
        self.tabs.addTab(self.tab_main2, "422")
    ...
    def set_point_update(self):
        ...
        file = open("z:\\Logs\\390_setpoint.txt", "w")
    ...
    def set_point_update2(self):
        ...
        # update set point
        #file = open("../Prehistoric-Data-Acquisition/setpoint.txt", "w")
        file = open("z:\\Logs\\422_setpoint.txt", "w")
    ...
    def read_set_point(self):
        ...
        file = open("z:\\Logs\\390_setpoint.txt", "r")
    ...
    def read_set_point2(self):
        ...
        # update set point
        #file = open("../Prehistoric-Data-Acquisition/setpoint.txt", "r")
        file = open("z:\\Logs\\422_setpoint.txt", "r")
