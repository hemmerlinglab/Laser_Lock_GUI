...
def get_frequencies(opts, channel = None):
    ...
    if not channel == None:
        ...
        # changing fiber switcher channel
        # Send data
        message = 'chann ' + str(channel)
...
opts = {
        ...
        'pids' : {
            5 : {'laser' : 422, 'wavemeter_channel' : 5, 'Kp' : 1, 'Ki' : 100, 'sign' : 1, 'DAC_chan' : 1},
...
#while True:
if True:
    data = get_frequencies(opts, channel = 6)
    data = get_frequencies(opts, channel = 5)
